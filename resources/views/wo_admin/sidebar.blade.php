                    ...
                    <nav id="js-primary-nav" class="primary-nav" role="navigation">
                        ...
                        <div class="info-card">
                            ...
                            <div class="info-card-text">
                                <a href="{{ route('dataProfileWo') }}" class="d-flex align-items-center text-white">
                        ...
                        <a href="{{ route('dataPaketWo') }}" title="Paket" data-filter-tags="paket">
                                    <i class="fal fa-image"></i>
                                    <span class="nav-link-text" data-i18n="nav.paket">Paket</span>
                                </a>
                        ...
                        <a href="{{ route('dataLayananWO') }}" title="Layanan" data-filter-tags="layanan">
                                    <i class="fal fa-image"></i>
                                    <span class="nav-link-text" data-i18n="nav.layanan">Layanan</span>
                                </a>
                        ...
                        <a href="{{ route('dataProfileWo') }}" title="Profile" data-filter-tags="infografis">
                                    <i class="fal fa-image"></i>
                        ...
                        <a href="{{ route('dataTransaksiView') }}" title="Transaksi" data-filter-tags="infografis">
                                    <i class="fal fa-image"></i>
