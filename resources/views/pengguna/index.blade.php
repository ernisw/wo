    ...
    <thead>
        ...
        <tr>
            ...
            <td>
                ...
                <a href="{{ route('formEditPengguna', $data->id) }}">
            ...
            <td>
                    <a href="{{ route('konfirmasiRegis', $data->id) }}">
                        <button onclick="return konfirmasi()" class="btn btn-warning">Konfirmasi</button>
                    </a>

                    <a href="{{ route('tolakRegis', $data->id) }}">
                        <button onclick="return konfirmasi()" class="btn btn-warning">Tolak</button>
                    </a>
                    <!-- <a href="{{ route('belumProses', $data->id) }}">
                        <button onclick="return konfirmasi()" class="btn btn-warning">Belum di Proses</button>
                    </a> -->
                </td>
        </tr>
        @endforeach
